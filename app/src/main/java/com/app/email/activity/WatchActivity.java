...
import com.app.email.Utils;
import com.app.email.adapter.AttachmentAdapter;
import com.app.email.adapter.item.AttachmentItem;
import com.app.email.controls.Controls;
import com.app.email.table.LocalFile;
...
public class WatchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.email_activity_watch);
    }
    ...
    protected void initView() {
        ...
        folder = EmailKit.useIMAPService(MyApplication.getConfig()).getFolder(folderName);

        ((TextView) findViewById(R.id.email_activity_watch_subject_tv))
                .setText(TextUtils.isEmpty(localMsg.getSubject()) ? "（无主题）" : localMsg.getSubject());
        ((TextView) findViewById(R.id.email_activity_watch_sender_nickname_tv)).setText(localMsg.getSenderNickname());
        ((TextView) findViewById(R.id.email_activity_watch_sender_address_tv)).setText(localMsg.getSenderAddress());
        ((TextView) findViewById(R.id.email_activity_watch_recipient_nickname_tv)).setText(localMsg.getRecipientNickname());
        ((TextView) findViewById(R.id.email_activity_watch_recipient_address_tv)).setText(localMsg.getRecipientAddress());
        ((TextView) findViewById(R.id.email_activity_watch_date_tv)).setText(localMsg.getDate());
        ProgressBar progressBar = findViewById(R.id.email_activity_watch_progress_bar);

        webView = findViewById(R.id.email_activity_watch_content_wv);
    ...
    private void setAttachmentList(List<Message.Content.Attachment> attachmentList) {
        ...
        RecyclerView recyclerView = findViewById(R.id.email_activity_watch_attachment_rv);
