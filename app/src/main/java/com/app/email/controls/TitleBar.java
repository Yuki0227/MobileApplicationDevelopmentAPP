...
public class TitleBar {
    ...
    private void initView(final Activity activity) {
        title_bar_back_iv = activity.findViewById(R.id.email_title_bar_back_iv);
        title_bar_function_iv = activity.findViewById(R.id.email_title_bar_function_iv);
        title_bar_title_tv = activity.findViewById(R.id.email_title_bar_title_tv);
    }
