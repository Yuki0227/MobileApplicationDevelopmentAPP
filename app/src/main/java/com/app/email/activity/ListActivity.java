...
import com.app.email.adapter.MsgAdapter;
...
public class ListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.email_activity_list);
    }
    ...
    protected void initView() {
        ...
        SmartRefreshLayout smartRefreshLayout = findViewById(R.id.email_activity_list_msg_sr);
        ...
        RecyclerView recyclerView = findViewById(R.id.email_activity_list_msg_rv);
